...
<head>
    ...
    <title>Lecturer Denied Access</title>
    <!-- Bootstrap core CSS-->
    <!-- Bootstrap core CSS-->
...
<div class="container">
    ...
    <div class="card card-login mx-auto mt-5">
        <div class="card-body">
        <h4 class="text-danger">Sorry, it seems this page could not be found or you simply don't have clearance for the course</h4>
          </div>
       <div class="card-footer">
           <a href="{{url('lecturer')}}">Return back to dashboard <i class="fa fa-arrow-left"></i></a>
       </div>
